package Tema3.TCP.U3P5Teatre_Solucio;
	...
	public U3P5Servidor() {
		...
		try {
			...
			while (true) {
				...
				dosEixida.writeUTF("Hola s�c el servidor");
				...
				do {
					...
					// CADENA "Veure butaques" MOSTRA INFORMACI�
						...
						// HE RECORREGUT PER� NO HE TROBAT LA CADENA. ERROR!
